...
await build({root:source,configFile:false,plugins:[{name:'er-wiki-desktop',enforce:'pre',transform:integrateDesktop(here)},react()],
  resolve:{alias:{react:path.join(source,'node_modules/react'),'react-dom':path.join(source,'node_modules/react-dom'),'@douyinfe/semi-ui':path.join(source,'node_modules/@douyinfe/semi-ui')}},
